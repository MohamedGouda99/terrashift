...
mod common;
use common::seed_fixtures::minimal_required_attrs;
...
// Schema-driven helpers (`minimal_required_attrs`, `seed_schema_path`,
// `synthesize_value`, `template_policy_required`) live in
// `tests/common/seed_fixtures.rs` so verifier_test.rs and future test
// binaries can reuse them. See feedback memory:
// `feedback_no_hardcoding_use_seed.md`.
